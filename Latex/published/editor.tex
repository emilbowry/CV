...
\begin{itemize} 
        ...
        \item Adds new features, such as a persistent homepage, and cross-codebase note-taking system.
\end{itemize}
}{}

\ifattr{web_based}{%
A fork of Microsoft VSCode that: Improves supply chain security by removing telemetry ``at the source'';  Removes LLM, MCP and agentic AI; and adds new features, such as a persistent homepage, and cross-codebase note taking system.
\end{position}
}{
}
