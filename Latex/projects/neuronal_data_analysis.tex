...
Built an  ETL (Extract, Transform, Load) framework for Lateral Intraparietal Cortex (LIP) neuron impulses, in order to analyse stochastic models The core objective was to evaluate and test different statistical models for varying models.
