...
Built an simulation framework for Lateral Intraparietal Cortex (LIP) neuron impulses, in order to analyse stochastic models The core objective was to evaluate and test different statistical models for varying models.
...
\begin{itemize}
	...
	\item Centralise transformation between different data formats, like ones appropriate for histograms, spike rasters and the ability to apply smoothing and other functions to the data.
