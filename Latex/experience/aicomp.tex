...
% 3.c `dynamic background image generator`: Novel client side image rasterisation for css compatibility
% 3.d `euclidian torus` utilises Topology to create a robust UI/UX for data of an undefined length
